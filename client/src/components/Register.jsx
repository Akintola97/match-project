      ...
      <div className="bg-white p-12 rounded shadow-lg">
        ...
        <form onSubmit={handleSubmit} className='h-full'>
          <div className='p-5 border-b text-black'>
            <input className="w-full border-b rounded-lg py-2 px-3 focus:outline-none focus:border-green-500" type='text' placeholder='First Name...' onChange={(e)=>setFirstName(e.target.value)} value={firstName}  required />
          </div>
          <div className='p-5 border-b text-black'>
            <input className="w-full border-b rounded-lg py-2 px-3 focus:outline-none focus:border-green-500" type='email' placeholder='Email...' onChange={(e)=>setEmail(e.target.value)} value={email}  required />
          </div>
