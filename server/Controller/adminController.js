...
//   try {
//     // Aggregation pipeline to fetch users along with their profiles, carts, and messages
//     const userData = await User.aggregate([
//       {
//         // Lookup profiles
//         $lookup: {
//           from: "profiles", // This should match the MongoDB collection name for profiles
//           localField: "_id",
//           foreignField: "user",
//           as: "profile",
//         },
//       },
//       {
//         // Since $lookup returns an array, $unwind is used to flatten it
//         $unwind: "$profile",
//       },
//       {
//         // Lookup carts
...
//       },
//       {
//         // Optional: Unwind the cart if you need to work with it as an object
//         $unwind: {
//           path: "$cart",
...
//       },
//       {
//         // Lookup item details for cart items
//         $lookup: {
//           from: "items", // Adjust to your items collection name
//           localField: "cart.items.item",
//           foreignField: "_id",
//           as: "cart.items.itemDetails",
//         },
//       },
//       {
//         // Lookup messages
//         $lookup: {
//           from: "messages", // Adjust to your messages collection name
//           localField: "_id",
//           foreignField: "user",
//           as: "messages",
//         },
//       },
//       {
//         // Group the information by user ID
//         $group: {
//           _id: "$_id",
//           root: { $mergeObjects: "$$ROOT" }, // Merge the document fields
//           cartItems: { $push: "$cart.items" }, // Collect cart items
//           messages: { $first: "$messages" }, // Collect messages
//         },
//       },
//       {
//         // Replace the root to structure the document including profile, cart, and messages
//         $replaceRoot: {
//           newRoot: {
//             $mergeObjects: [
//               "$root",
...
//       cart: user.cart
//         ? user.cart.items.flatMap((item) => item.itemDetails)
//         : [],
...
//           preserveNullAndEmptyArrays: true,
//         }},
//       { $unwind: "$cart.items" }, // Unwind items to work with them individually
//       { $lookup: {
//           from: "items",
//           localField: "cart.items.item",
//           foreignField: "_id",
//           as: "cart.items.itemDetails",
//         }},
//       { $unwind: "$cart.items.itemDetails" }, // Flatten itemDetails
//       { $group: { // Regroup to revert the unwinding
//           _id: "$_id",
//           profile: { $first: "$profile" },
//           cartItems: { $push: "$cart.items" }, // Collect cart items alongside their details
...
//           as: "messages",
//         }},
//       { $addFields: { // Flatten profile, cart, and messages into the top level
//           cart: { items: "$cartItems" },
//         }},
//       { $project: { // Exclude cartItems from the final projection
//           cartItems: 0,
//         }},
//     ]);

//     // Transform the userData to include details and quantities
//     const usersWithDetails = userData.map(user => ({
//       ...user,
//       isActive: user.profile.isActive,
//       profile: user.profile,
...
//           ...item.itemDetails, // Spread itemDetails directly
