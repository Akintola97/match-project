...
const {register, login, authenticate, userInfo, logout, getProfile, updateProfile, hero_page, messages, people, deleteOrDeactivateUser } = require('../Controller/authController');
