...
const {register, login, authenticate, userInfo, logout, getProfile, updateProfile, hero_page, messages, people, deleteOrDeactivateUser, activate } = require('../Controller/authController');
